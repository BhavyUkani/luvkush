...
const EMPTY = () => ({
  ...
  size_info: '', colour_info: '', how_to_use: '',
  ...
  template: `
    <div class="page">
      <div class="page-header">
        <h1>Hair Patches <span class="count">{{ items().length }}</span></h1>
        <button class="btn-primary" (click)="openCreate()">+ Add Patch</button>
      </div>
      ...
      @else {
        <table class="data-table">
          <thead><tr>
            ...
            <th>Image</th><th>Name</th><th>Price</th><th>Size</th><th>Status</th><th>Actions</th>
          </tr></thead>
          <tbody>
    ...
    @if (showForm()) {
      <div class="modal-backdrop" (click)="closeForm()">
        <div class="modal modal-lg" (click)="$event.stopPropagation()">
          <div class="modal-header">
            <h2>{{ editingId() ? 'Edit Patch' : 'Add Hair Patch' }}</h2>
          ...
          <div class="modal-body">
            <div class="form-grid">
              <div class="field field-full">
                <label>Name *</label>
                <input type="text" [(ngModel)]="form().name" class="form-input" placeholder="Patch name" />
              </div>
              <div class="field field-full">
              ...
              <div class="field field-full">
                ...
                <input type="text" [(ngModel)]="form().size_info" class="form-input" placeholder="e.g. 6x8 cm, 8x10 cm, 10x12 cm" />
              </div>
              <div class="field field-full">
              ...
              <div class="field field-full">
                ...
                <textarea [(ngModel)]="form().how_to_use" class="form-input" rows="4" placeholder="Application instructions..."></textarea>
              </div>
              ...
              @if (editingId()) {
                <div class="field field-full" style="margin-top: 1rem;">
                  ...
                  <div class="img-upload-zone">
                    @if (imgPreview()) {
                      <div class="img-preview-wrap"><img [src]="imgPreview()" class="img-preview" alt="Preview" /></div>
                    } @else if (form().primary_image) {
                      <div class="img-preview-wrap"><img [src]="imgUrl(form().primary_image)" class="img-preview" alt="Current" /></div>
                    }
          ...
          <div class="modal-footer">
            ...
            <button class="btn-primary" (click)="save()" [disabled]="saving()">
              {{ saving() ? 'Saving...' : (editingId() ? 'Update' : 'Create Patch') }}
            </button>
          </div>
        </div>
      </div>
...
export class AdminHairPatchesComponent implements OnInit {
  ...
  load(): void {
    ...
    this.error.set('');
    this.api.get<any>('/admin/hair-solutions?type=patch').subscribe({
